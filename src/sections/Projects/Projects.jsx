...
function Projects() {
  return (
    <section className={styles.container}>
        ...
        <div className={styles.projects}>
            <ProjectCard src={black} link='https://github.com/mateuszsiwy/ApartmentManagementSystem' h3='Apartment Management System' p='A web application that allows data management through an API client.'/>
